            ...
            <Paper sx={{ p: 4 }}>
                ...
                {tabIndex === 0 && ( // UI cho login
                    <Box component="form" noValidate onSubmit={handleLoginSubmit(onLoginSubmit)}>
                        <Typography varient="h6" gutterBottom>Login</Typography>
                        <TextField
                            label="Login Name" variant="outlined" fullWidth margin="normal"
                            {...loginForm("login_name", { required: "Login name is required" })}
                            error={!!loginErrors.login_name}
                            helperText={loginErrors.login_name?.message}
                        />
                        <TextField
                            label="Password" type="password" variant="outlined" fullWidth margin="normal"
                        ...
                        <Button type="submit" varient="contained" color="primary" fullWidth sx={{ mt: 3 }}>Login</Button>
                    </Box>
                )}

                {tabIndex === 1 && ( // UI cho register
                    <Box component="form" noValidate onSubmit={handleRegisterSubmit(onRegisterSubmit)}>
                        <Typography varient="h6" gutterBottom>Register new user</Typography>
                        <TextField
                            label="Login Name" variant="outlined" fullWidth margin="normal"
                            {...registerForm("login_name", { required: "Login name is required" })}
                        ...
                        />
                        <TextField
                            label="Confirm Password" type="password" variant="outlined" fullWidth margin="normal"
                        ...
                        />
                        <TextField
                            label="First Name" variant="outlined" fullWidth margin="normal"
                        ...
                        />
                        <TextField
                            label="Last Name" variant="outlined" fullWidth margin="normal"
                        ...
                        />
                        <TextField
                            label="Location" variant="outlined" fullWidth margin="normal"
                        ...
                        />
                        <TextField
                            label="Occupation" variant="outlined" fullWidth margin="normal"
                            {...registerForm("occupation")}
                        />

                        {registerError && (
                            <Alert severity="error" sx={{ mt: 2 }}>{registerError}</Alert>
                        )}
                        {registerSuccess && (
                            <Alert severity="success" sx={{ mt: 2 }}>{registerSuccess}</Alert>
                        )}
                        <Button type="submit" varient="contained" color="primary" fullWidth sx={{ mt: 3 }}>Register</Button>
                    </Box>
                )}
            </Paper>
        </Box>
